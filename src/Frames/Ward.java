...
public class Ward extends javax.swing.JFrame {
    ...
    public Ward() {
        ...
        wardTypeCB.addItem("PRIVATE");
        wardTypeCB.addItem("SEMI PRIVATE");
        wardTypeCB.addItem("GENERAL WARD");
    }
...
//           if(bean==null)return;
//           try{
//               Vector v = databaseManager.getWard(bean.getPatientId());
//               wTL.setListData(v);
//           }catch(Exception e){
//              e.printStackTrace();
//              JOptionPane.showMessageDialog(this,"Error"+e.getMessage());
...
//           
//       }
//    private void getWard1(){
//            //patientBean bean = (patientBean)patientCB.getSelectedItem();
//            staffBean bean = (staffBean)staffCB.getSelectedItem();
//           if(bean==null)return;
//           try{
//               Vector v = databaseManager.getWard1(bean.getStaffId());
//               wTL.setListData(v);
//           }catch(Exception e){
//              e.printStackTrace();
//              JOptionPane.showMessageDialog(this,"Error"+e.getMessage());
...
//       }
 ...
 private void addRecord(){
         ...
         staffBean bean1=(staffBean)staffCB.getSelectedItem();
       if(bean==null)return;  
            String  wardType          = Encoder.wardTypeEncode((String)wardTypeCB.getSelectedItem());
            int     chargesPerDay     = Integer.parseInt(cPDTF.getText());
            int     foodCharges       = Integer.parseInt(fCTF.getText());
            String  remarks           = remarksTF.getText();
            try{
                int rows=databaseManager.addWard(bean.getPatientId(),bean1.getStaffId(),wardType,chargesPerDay,foodCharges,remarks);
                if(rows>=1)
...
//                getWard();
    ...
    private void updateRecord(){
         wardBean bean=(wardBean)wTL.getSelectedValue();
         ...
         if(bean==null)return ;
            ...
            String  remarks           = remarksTF.getText();
         try{
          int rows=databaseManager.updateWard(bean.getWardId(),bean1.getPatientId(),bean2.getStaffId(),wardType,chargesPerDay,foodCharges,remarks);
...
//                getWard();
    ...
    if(bean==null)return;
    try{
        int rows = databaseManager.deleteWard(bean.getWardId());
          if(rows>=1)
...
//                getWard();
    ...
    private void initComponents() {
        ...
        wITF = new javax.swing.JTextField();
        cPDTF = new javax.swing.JTextField();
        fCTF = new javax.swing.JTextField();
        jLabel28 = new javax.swing.JLabel();
        jScrollPane1 = new javax.swing.JScrollPane();
        wTL = new javax.swing.JList();
        ...
        wardTypeCB = new javax.swing.JComboBox<>();
        ...
        jLabel25.setText("WARD TYPE");
        getContentPane().add(jLabel25);
        jLabel25.setBounds(830, 140, 100, 40);

        jLabel26.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabel26.setText("CHARGES PER DAY");
        getContentPane().add(jLabel26);
        jLabel26.setBounds(780, 190, 150, 40);

        jLabel27.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabel27.setText("WARD TYPE");
        getContentPane().add(jLabel27);
        jLabel27.setBounds(1180, 90, 110, 30);

        wITF.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        getContentPane().add(wITF);
        wITF.setBounds(930, 90, 100, 40);

        cPDTF.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        getContentPane().add(cPDTF);
        cPDTF.setBounds(930, 190, 240, 40);

        fCTF.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        getContentPane().add(fCTF);
        fCTF.setBounds(930, 240, 240, 40);

        jLabel28.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabel28.setText("WARD ID");
        getContentPane().add(jLabel28);
        jLabel28.setBounds(850, 90, 80, 40);

        wTL.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        wTL.addListSelectionListener(new javax.swing.event.ListSelectionListener() {
            public void valueChanged(javax.swing.event.ListSelectionEvent evt) {
                wTLValueChanged(evt);
            }
        });
        jScrollPane1.setViewportView(wTL);

        getContentPane().add(jScrollPane1);
        jScrollPane1.setBounds(1180, 120, 170, 290);

        jLabel33.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabel33.setText("FOOD CHARGES");
        getContentPane().add(jLabel33);
        jLabel33.setBounds(800, 240, 130, 40);
        ...
        wardTypeCB.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        getContentPane().add(wardTypeCB);
        wardTypeCB.setBounds(930, 140, 240, 40);
        ...
        jComboBox1.setBounds(1180, 60, 160, 30);
        ...
        jLabel37.setBounds(440, 140, 110, 30);
    ...
    private void wTLValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_wTLValueChanged
        // TODO add your handling code here:
        wardBean bean=(wardBean)wTL.getSelectedValue();
    
       if(bean==null)return;
       wardTypeCB.setSelectedItem(Decoder.wardTypeDecode((String)wardTypeCB.getSelectedItem()));
      
       wITF.setText(""+bean.getWardId());
       cPDTF.setText(""+bean.getChargesPerDay());
       fCTF.setText(""+bean.getFoodCharges());
       remarksTF.setText(bean.getRemarks());
    }//GEN-LAST:event_wTLValueChanged
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        // TODO add your handling code here:
         wardBean bean =(wardBean)jComboBox1.getSelectedItem();
    ...
    private javax.swing.JTextField cPDTF;
    ...
    private javax.swing.JTextField fCTF;
    ...
    private javax.swing.JTextField wITF;
    private javax.swing.JList wTL;
    private javax.swing.JComboBox<String> wardTypeCB;
